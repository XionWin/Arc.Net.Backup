...
namespace EGL
{
    ...
    unsafe public static class Extension
    {
            ...
            RenderableSurfaceType surfaceType)
        {
            ...
            Console.WriteLine($"Client Version: {GetVersion(IntPtr.Zero)}");
            Console.WriteLine($"Client Vendor: {GetVendor(IntPtr.Zero)}");
            Console.WriteLine($"Client Extensions: {GetExtensions(IntPtr.Zero)}");
            ...
            Console.WriteLine($"Display Version: {GetVersion(result.display)}");
            Console.WriteLine($"Display Vendor: {GetVendor(result.display)}");
            Console.WriteLine($"Display Extensions: {GetExtensions(result.display)}");
            ...
            var desiredConfig = new[] {
                ...
                Definition.RENDERABLE_TYPE, Definition.OPENGL_ES2_BIT,
