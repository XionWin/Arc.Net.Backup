...
public static class FFI
{
    ...
    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glBindTexture(TextureTarget target, int textureId);
    ...
    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glGenerateMipmap(TextureTarget target);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glPixelStorei (PixelStoreParameter pixelStoreParameter, int v0);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glBindVertexArray (int array);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glGenVertexArrays(int n, out int arrayId);


    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glGenBuffers(int n, out int bufferId);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glBindBuffer(BufferTarget target, int bufferId);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glDeleteBuffers(int n, int[] bufferIds);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glDeleteVertexArrays(int n, int[] arrayIds);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glBufferData (BufferTarget target, int size, nint data, BufferUsageHint bufferUsageHint);
    ...
    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glBlendFunc(BlendingFactorSrc src, BlendingFactorDest dest);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glDrawArrays(PrimitiveType primitiveType, int index, int len);
    ...
    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glStencilFunc(StencilFunction func, int @ref, uint mask);

    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glColorMask(bool r, bool g, bool b, bool a);


    [DllImport(Lib.Name, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void glStencilOpSeparate(StencilFace face, StencilOp sfail, StencilOp dpfail, StencilOp dppass);
