...
public static class ArcTest
{
    public static Vertex[][] Test()
    {
        ...
        context.GetState().StrokeWidth = 25;
        ...
        path.AddCommand(new Command(CommandType.LineTo, (float)(l + r2 * Math.Cos(tick2) + r1 * Math.Cos(tick1) + r2 * Math.Cos(tick2)), (float)(t + r2 * Math.Sin(tick2) + r1 * Math.Sin(tick1) + r2 * Math.Sin(tick2))));
