...
//         context.SaveState();
//         context.GetState().StrokeWidth = 9;
//         context.GetState().StrokePaint.InnerColor = new Color(0, 0, 24, 255);
//         context.GetState().FillPaint.InnerColor = new Color(0, 0, 0, 255);
//         context.AddCommand(CommandType.MoveTo, 100, 100);
//         context.AddCommand(CommandType.LineTo, 600, 100);
//         context.AddCommand(CommandType.LineTo, 100, 300);
